...
namespace HdrpTOUrpDowngrader
{
    ...
    class DowngradeHdrpTOUrpMats
    {
        ...
        [MenuItem("Edit/Render Pipeline/Downgrade All HDRP Materials to URP Materials", priority = CoreUtils.Priorities.editMenuPriority)]
        ...
        [MenuItem("Edit/Render Pipeline/Downgrade Selected HDRP Materials to URP Materials", priority = CoreUtils.Priorities.editMenuPriority)]
